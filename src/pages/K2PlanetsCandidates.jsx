...
const K2PlanetsCandidates = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('/api/k2-planets-candidates');
        setData(response.data);
      } catch (err) {
        setError('Failed to fetch K2 planets and candidates data');
      }
    };
  ...
  return (
    <div>
      <h1>K2 Planets and Candidates</h1>
...
export default K2PlanetsCandidates;