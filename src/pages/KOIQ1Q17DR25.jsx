...
const KOIQ1Q17DR25 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('/api/koi-q1q17-dr25');
        setData(response.data);
      } catch (err) {
        setError('Failed to fetch KOI Q1-Q17 DR25 Delivery data');
      }
    };
  ...
  return (
    <div>
      <h1>KOI Q1-Q17 DR25 Delivery</h1>
