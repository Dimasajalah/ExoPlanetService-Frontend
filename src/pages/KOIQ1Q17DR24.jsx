...
const KOIQ1Q17DR24 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('/api/koi-q1q17-dr24');
        setData(response.data);
      } catch (err) {
        setError('Failed to fetch KOI Q1-Q17 DR24 Delivery data');
      }
    };
  ...
  return (
    <div>
      <h1>KOI Q1-Q17 DR24 Delivery</h1>
