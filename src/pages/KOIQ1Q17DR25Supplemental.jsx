...
const KOIQ1Q17DR25Supplemental = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('/api/koi-q1q17-dr25-supplemental');
        setData(response.data);
      } catch (err) {
        setError('Failed to fetch KOI Q1-Q17 DR25 Supplemental Delivery data');
      }
    };
  ...
  return (
    <div>
      <h1>KOI Q1-Q17 DR25 Supplemental Delivery</h1>
...
export default KOIQ1Q17DR25Supplemental;